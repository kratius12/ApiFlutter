...
class SolicitarServicioForm extends StatefulWidget {
  final int idCli;
  const SolicitarServicioForm({Key? key, required this.idCli})
      : super(key: key);
...
class _SolicitarServicioFormState extends State<SolicitarServicioForm> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title:
            const Text("Solicitar cita", style: TextStyle(color: Colors.white)),
      ...
      body: Stack(
        children: [
                            ...
                            child: ElevatedButton(
                              onPressed: () async {
                                if (_formKey.currentState!.validate()) {
                                  setState(() {
                                    isLoading =
                                        true; // Muestra la transición de carga
                                  });
                                  ...
                                  setState(() {
                                    isLoading =
                                        false; // Oculta la transición de carga
                                  });
          ...
          if (isLoading) // Si isLoading es true, muestra el indicador de carga
            Container(
              color: Colors.black
